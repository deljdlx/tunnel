...
function renderHorizontalTable($array)
{
    ...
    foreach ($array as $index => $value) {
        if (is_array($value)) {
            ...
            $valuesBuffer .= '<td class="index-'.$index.'">'.$value.'</td>';
        } else {
            $valuesBuffer .= '<td class="index-'.$index.'"><span class="value '.gettype($value).'">'.$value.'<span></td>';
        }
...
function renderVerticalTable($array)
{
    ...
    foreach ($array as $index => $value) {
        ...
        if (is_array($value)) {
            ...
            $buffer .= '<td class="index-'.$index.'">'.$value.'</td>';
        } else {
            $buffer .= '<td class="index-'.$index.'"><span class="value '.gettype($value).'">'.$value.'</span></td>';
        }
